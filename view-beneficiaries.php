        ...
        <div class="content">
            ...
            <div class="cards1">
                <table class="table">
                    ...
                    <tr class="beneficiary-row">
                        ...
                        <td>
                            <a class="update-button" href="update-beneficiary.php?id=<?php echo $rows['bid']; ?>">Update</a>
                            <a class="delete-button" href="delete-beneficiary.php?id=<?php echo $rows['bid']; ?>" onclick="return confirm('Are you sure you want to delete this beneficiary?');">Delete</a>
                        </td>
                    </tr>
                    <?php
                        }
            ...
            <div class="pagination">
                ...
                for ($page_number = 1; $page_number <= $total_pages; $page_number++) {
                    echo '<a href="view-beneficiaries.php?page=' . $page_number . '" class="' . ($page_number == $page ? 'active' : '') . '">' . $page_number . '</a>';
                }
                ?>
            </div>
        </div>
